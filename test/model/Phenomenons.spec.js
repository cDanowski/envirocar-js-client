...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('Phenomenons', function() {
      beforeEach(function() {
        instance = new EnviroCarRestApi.Phenomenons();
      });

      it('should create an instance of Phenomenons', function() {
        // TODO: update the code to test Phenomenons
        expect(instance).to.be.a(EnviroCarRestApi.Phenomenons);
      });
