...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('TermsOfUseInstance', function() {
      beforeEach(function() {
        instance = new EnviroCarRestApi.TermsOfUseInstance();
      });

      it('should create an instance of TermsOfUseInstance', function() {
        // TODO: update the code to test TermsOfUseInstance
        expect(instance).to.be.a(EnviroCarRestApi.TermsOfUseInstance);
      });
