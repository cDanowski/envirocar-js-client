...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('CarProperties', function() {
      beforeEach(function() {
        instance = new EnviroCarRestApi.CarProperties();
      });

      it('should create an instance of CarProperties', function() {
        // TODO: update the code to test CarProperties
        expect(instance).to.be.a(EnviroCarRestApi.CarProperties);
      });
