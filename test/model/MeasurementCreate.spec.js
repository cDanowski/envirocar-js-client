...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('MeasurementCreate', function() {
      beforeEach(function() {
        instance = new EnviroCarRestApi.MeasurementCreate();
      });

      it('should create an instance of MeasurementCreate', function() {
        // TODO: update the code to test MeasurementCreate
        expect(instance).to.be.a(EnviroCarRestApi.MeasurementCreate);
      });
