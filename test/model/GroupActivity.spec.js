...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('GroupActivity', function() {
      beforeEach(function() {
        instance = new EnviroCarRestApi.GroupActivity();
      });

      it('should create an instance of GroupActivity', function() {
        // TODO: update the code to test GroupActivity
        expect(instance).to.be.a(EnviroCarRestApi.GroupActivity);
      });
