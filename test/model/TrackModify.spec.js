...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('TrackModify', function() {
      beforeEach(function() {
        instance = new EnviroCarRestApi.TrackModify();
      });

      it('should create an instance of TrackModify', function() {
        // TODO: update the code to test TrackModify
        expect(instance).to.be.a(EnviroCarRestApi.TrackModify);
      });
