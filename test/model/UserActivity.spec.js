...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('UserActivity', function() {
      beforeEach(function() {
        instance = new EnviroCarRestApi.UserActivity();
      });

      it('should create an instance of UserActivity', function() {
        // TODO: update the code to test UserActivity
        expect(instance).to.be.a(EnviroCarRestApi.UserActivity);
      });
