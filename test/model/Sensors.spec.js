...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('Sensors', function() {
      beforeEach(function() {
        instance = new EnviroCarRestApi.Sensors();
      });

      it('should create an instance of Sensors', function() {
        // TODO: update the code to test Sensors
        expect(instance).to.be.a(EnviroCarRestApi.Sensors);
      });
