...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('Linestring', function() {
      beforeEach(function() {
        instance = new EnviroCarRestApi.Linestring();
      });

      it('should create an instance of Linestring', function() {
        // TODO: update the code to test Linestring
        expect(instance).to.be.a(EnviroCarRestApi.Linestring);
      });
