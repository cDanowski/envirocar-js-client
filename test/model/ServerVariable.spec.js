...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('ServerVariable', function() {
      beforeEach(function() {
        instance = new EnviroCarRestApi.ServerVariable();
      });

      it('should create an instance of ServerVariable', function() {
        // TODO: update the code to test ServerVariable
        expect(instance).to.be.a(EnviroCarRestApi.ServerVariable);
      });
