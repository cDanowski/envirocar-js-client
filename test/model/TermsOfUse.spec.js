...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('TermsOfUse', function() {
      beforeEach(function() {
        instance = new EnviroCarRestApi.TermsOfUse();
      });

      it('should create an instance of TermsOfUse', function() {
        // TODO: update the code to test TermsOfUse
        expect(instance).to.be.a(EnviroCarRestApi.TermsOfUse);
      });
