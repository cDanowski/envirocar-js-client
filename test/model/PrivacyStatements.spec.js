...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('PrivacyStatements', function() {
      beforeEach(function() {
        instance = new EnviroCarRestApi.PrivacyStatements();
      });

      it('should create an instance of PrivacyStatements', function() {
        // TODO: update the code to test PrivacyStatements
        expect(instance).to.be.a(EnviroCarRestApi.PrivacyStatements);
      });
