...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('Tracks', function() {
      beforeEach(function() {
        instance = new EnviroCarRestApi.Tracks();
      });

      it('should create an instance of Tracks', function() {
        // TODO: update the code to test Tracks
        expect(instance).to.be.a(EnviroCarRestApi.Tracks);
      });
