...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('Schemas', function() {
      beforeEach(function() {
        instance = new EnviroCarRestApi.Schemas();
      });

      it('should create an instance of Schemas', function() {
        // TODO: update the code to test Schemas
        expect(instance).to.be.a(EnviroCarRestApi.Schemas);
      });
