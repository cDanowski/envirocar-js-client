 ...
 * @version 1.0.0
 */
var UserCreate = /*#__PURE__*/function (_OptionalUserProperti) {
  _inherits(UserCreate, _OptionalUserProperti);
  var _super = _createSuper(UserCreate);
  /**
   ...
   */
  function UserCreate(name, mail, token, acceptedTerms, acceptedPrivacy) {
    var _this;
    ...
    _this.mail = mail;
    _this.token = token;
    _this.acceptedTerms = acceptedTerms;
    _this.acceptedPrivacy = acceptedPrivacy;
    return _this;
  }
  ...
  _createClass(UserCreate, null, [{
    ...
    value: function constructFromObject(data, obj) {
      if (data) {
        ...
        if (data.hasOwnProperty('mail')) obj.mail = _ApiClient.ApiClient.convertToType(data['mail'], 'String');
        if (data.hasOwnProperty('token')) obj.token = _ApiClient.ApiClient.convertToType(data['token'], 'String');
        if (data.hasOwnProperty('acceptedTerms')) obj.acceptedTerms = _ApiClient.ApiClient.convertToType(data['acceptedTerms'], 'Boolean');
        if (data.hasOwnProperty('acceptedPrivacy')) obj.acceptedPrivacy = _ApiClient.ApiClient.convertToType(data['acceptedPrivacy'], 'Boolean');
      }
      return obj;
    }
  }]);
