...
exports.PrivacystatementsPrivacyStatements = void 0;
 ...
 * @version 1.0.0
 */
var PrivacystatementsPrivacyStatements = /*#__PURE__*/function () {
  /**
   ...
   */
  function PrivacystatementsPrivacyStatements(id, issuedDate) {
    _classCallCheck(this, PrivacystatementsPrivacyStatements);
    this.id = id;
   ...
   */
  _createClass(PrivacystatementsPrivacyStatements, null, [{
  ...
  return PrivacystatementsPrivacyStatements;
}();
/**
 * @member {String} id
 */
exports.PrivacystatementsPrivacyStatements = PrivacystatementsPrivacyStatements;
