 ...
 * @version 1.0.0
 */
var TrackActivity = /*#__PURE__*/function () {
  /**
  ...
  function TrackActivity() {
    _classCallCheck(this, TrackActivity);
  }
   ...
   */
  _createClass(TrackActivity, null, [{
    key: "constructFromObject",
    value: function constructFromObject(data, obj) {
      if (data) {
        obj = obj || new TrackActivity();
        if (data.hasOwnProperty('track')) obj.track = _TrackReference.TrackReference.constructFromObject(data['track']);
