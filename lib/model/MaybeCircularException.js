...
exports.MaybeCircularException = void 0;
 ...
 * @version 1.0.0
 */
var MaybeCircularException = /*#__PURE__*/function () {
  /**
   * Constructs a new <code>MaybeCircularException</code>.
   * @alias module:model/MaybeCircularException
   * @class
   */
  function MaybeCircularException() {
    _classCallCheck(this, MaybeCircularException);
  }
   ...
   */
  _createClass(MaybeCircularException, null, [{
  ...
  return MaybeCircularException;
}();
exports.MaybeCircularException = MaybeCircularException;