...
var _SensorProperties = require("./SensorProperties");
 ...
 * @version 1.0.0
 */
var Sensor = /*#__PURE__*/function (_Base) {
  _inherits(Sensor, _Base);
  var _super = _createSuper(Sensor);
  /**
   ...
   * @param properties {} 
   */
  function Sensor(type, properties) {
   ...
   */
  _createClass(Sensor, null, [{
    key: "constructFromObject",
    value: function constructFromObject(data, obj) {
      if (data) {
        obj = obj || new Sensor();
        _Base2.Base.constructFromObject(data, obj);
        if (data.hasOwnProperty('properties')) obj.properties = _SensorProperties.SensorProperties.constructFromObject(data['properties']);
      }
      return obj;
    }
  }]);
