 ...
 * @version 1.0.0
 */
var TermsOfUse = /*#__PURE__*/function () {
  /**
   ...
   */
  function TermsOfUse(termsOfUse) {
   ...
   */
  _createClass(TermsOfUse, null, [{
    key: "constructFromObject",
    value: function constructFromObject(data, obj) {
      if (data) {
        obj = obj || new TermsOfUse();
        if (data.hasOwnProperty('termsOfUse')) obj.termsOfUse = _ApiClient.ApiClient.convertToType(data['termsOfUse'], [_PrivacystatementsPrivacyStatements.PrivacystatementsPrivacyStatements]);
      }
      return obj;
    }
  }]);
